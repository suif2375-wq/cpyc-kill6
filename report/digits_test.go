...
func TestExtendWithDigits(t *testing.T) {
	...
	for _, want := range []string{"<title>彩票数据预测参考</title>", "tab-p3", "排列3 三位杀码参考", "pane-p3", "V9局部公式", "2026235", "#tab-p3:checked~.tab-bar", "#tab-p5:checked~.tab-bar", "digit-history-toggle", "历史查询", "data-digit-history-search"} {
